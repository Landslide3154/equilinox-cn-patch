/*
 * Patched for Chinese localization (v7.1 fix):
 * 原版把数字("+692")与单位("dp/分")拆成两个 Text，分别固定在组件
 * 5% 与 64% 处，中间空隙过大。改为拼进同一个字符串：
 * "+692 dp/分"，数字与单位紧贴，随数字位数自然伸缩。
 */
package toolbar;
...
extends GuiComponent {
    ...
    public void setCount(int count) {
        final String countString = PLUS_TEXT + Maths.formatNumber(count) + " " + DP_TEXT;
