        ...
        switch (msg) {
            ...
            case 71: {
                if (this.getWindowRect(hwnd, rect_buffer)) {
                    rect.copyFromBuffer(rect_buffer);
                    this.x = WindowsDisplay.rect.top;
                    this.y = WindowsDisplay.rect.bottom;
                    break;
                }
    ...
    public void setResizable(boolean resizable) {
        if (this.resizable != resizable) {
            ...
            if (resizable && !Display.isFullscreen()) {
                WindowsDisplay.setWindowLongPtr(this.hwnd, -16, style |= 0x50000);
            } else {
                WindowsDisplay.setWindowLongPtr(this.hwnd, -16, style &= 0xFFFAFFFF);
            }
            WindowsDisplay.getClientRect(this.hwnd, rect_buffer);
            rect.copyFromBuffer(rect_buffer);
