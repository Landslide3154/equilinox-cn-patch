...
public class Fbo {
    ...
    private void initialiseFrameBuffer(FboBuilder.DepthBufferType type, boolean useColourBuffer, boolean linear, boolean clamp, int samples) {
        ...
        int statusId = GL30.glCheckFramebufferStatus(36160);
        if (statusId != 36053) {
            System.err.println("FRAMEBUFFER ISSUE: " + statusId);
        }
    ...
    public void createTextureAttachment(boolean linear, boolean clamp) {
        ...
        GL11.glTexImage2D(3553, 0, 32856, this.width, this.height, 0, 6408, 5121, null);
    ...
    private void attachMutlisampleColourBuffer(int samples) {
        ...
        GL30.glRenderbufferStorageMultisample(36161, samples, 32856, this.width, this.height);
