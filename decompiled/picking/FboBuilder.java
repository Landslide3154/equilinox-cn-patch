...
public class FboBuilder {
    ...
    public FboBuilder noColourBuffer() {
        this.colourBuffer = false;
        return this;
    }

    public Fbo create() {
        return new Fbo(this.width, this.height, this.depthBuffer, this.colourBuffer, this.linearFiltering, this.clampEdge, this.alphaChannel, this.antialiased, this.samples);
    }
